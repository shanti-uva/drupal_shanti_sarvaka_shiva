  ...
  <div class="shanti-thumbnail-info">
        <div class="body-wrap">
            <div class="shanti-thumbnail-field clearfix shanti-field-title">
                <span class="field-content"><a href="<?php print $node_url; ?>" class="shanti-thumbnail-link"><?php print $title; ?></a></span>
            </div>
            ...
            <div class="shanti-thumbnail-field clearfix shanti-field-created">
                <span class="shanti-field-content"><?php  print date('M j Y', $created) ?></span>
            </div>
